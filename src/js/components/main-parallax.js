...
// // parallaxMouse({ elements: '.footer__picture--one, .footer__picture--two, .footer__picture--three, .footer__picture--four, .footer__picture--five, .footer__picture--six', moveFactor: 20, wrap: '.footer--contacts'})
